        ...
        <div class="container-fluid">
            ...
            <div class="menu_btn collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-3 me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link hover-underline-animation" href="#">關於我們</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hover-underline-animation" href="#">最新消息</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hover-underline-animation" href="#">設計師</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link hover-underline-animation" href="#">推薦髮品</a>
                    </li>
                </ul>
    ...
    <div class="footer" style="background-color: var(--color25);">
        <div class="row text01">
            <div class="col-12 col-md-4">
                ...
                <div class="h4 mt-3">407台中市西屯區工業區一路100號</div>
            </div>
